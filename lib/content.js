...
export const getDocument=cache(async()=>{const rows=await sql`SELECT data,revision FROM cms_documents WHERE key='site'`;return rows[0]||{data:defaults,revision:0};});
